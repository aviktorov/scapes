...
VulkanSwapChain::VulkanSwapChain(const VulkanRendererContext &context, VkDeviceSize uboSize)
	: context(context)
	, uboSize(uboSize)
{
}
...
/*
 */
bool VulkanSwapChain::acquire(const RendererState &state, VulkanRenderFrame &frame)
{
