...
namespace scapes::visual::shaders
{
	...
	bool ShaderCache::load(foundation::io::FileSystem *file_system, const foundation::io::URI &cache_path)
	{
		foundation::io::Stream *cache_file = file_system->open(cache_path, "rb");
	...
	bool ShaderCache::flush(foundation::io::FileSystem *file_system, const foundation::io::URI &cache_path)
	{
		foundation::io::Stream *cache_file = file_system->open(cache_path, "ab");
		if (!cache_file)
			return false;
